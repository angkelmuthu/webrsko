...
class Model_common extends CI_Model
{
    ...
    public function all_page_sejarah()
    {
        $query = $this->db->query("SELECT * from tbl_page_sejarah WHERE id=1");
        return $query->first_row('array');
    }
    public function all_page_loker()
    {
        $query = $this->db->query("SELECT * from tbl_page_sejarah WHERE id=2");
        return $query->first_row('array');
    }
    ...
    public function all_page_pelayanan()
    {
    ...
    public function all_news_category()
    {
        $query = $this->db->query("SELECT *
                                ...
                                ORDER BY t1.news_id DESC limit 10");
        return $query->result_array();
    }
    public function all_news_category2()
    {
        $query = $this->db->query("SELECT *
                                FROM tbl_news t1
                                JOIN tbl_category t2
