...
class Model_common extends CI_Model 
{
    ...
    public function extension_check_photo($ext) {
    	if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' && $ext!='JPG' && $ext!='PNG' && $ext!='JPEG' && $ext!='GIF' && $ext!='pdf' && $ext!='PDF' && $ext!='doc' && $ext!='DOC' && $ext!='docx' && $ext!='DOCX' && $ext!='xls' && $ext!='XLS' && $ext!='XLSX' && $ext!='xlsx' && $ext!='rar' && $ext!='RAR' && $ext!='zip' && $ext!='ZIP' ) {
    		return false;
    	} else {
    		return true;
    	}
