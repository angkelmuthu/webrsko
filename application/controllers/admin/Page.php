...
class Page extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['page_sejarah'] = $this->Model_page->show_sejarah();
		$data['page_loker'] = $this->Model_page->show_loker();
	...
	public function update()
	{
		...
		if(isset($_POST['form_sejarah'])) {
        	$form_data = array(
				'sejarah_heading' => $_POST['sejarah_heading'],
				'sejarah_content' => $_POST['sejarah_content'],
				'mt_sejarah'      => $_POST['mt_sejarah'],
				'mk_sejarah'      => $_POST['mk_sejarah'],
				'md_sejarah'      => $_POST['md_sejarah']
            );
        	$this->Model_page->update_sejarah($form_data);
        	$success = 'Sejarah Page Setting is updated successfully!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
		...
		if(isset($_POST['form_loker'])) {
        	...
        	$this->Model_page->update_loker($form_data);
        	$success = 'Loker Page Setting is updated successfully!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}		
