...
<div class="banner-slider" style="background-image: url(<?php echo base_url(); ?>public/uploads/batik.jpg)">
    ...
    <div class="bannder-table">
        <div class="banner-text">
            <h1>ARTIKEL<?php //echo $page_news['news_heading']; 
                        ?></h1>
        </div>
    </div>
</div>
                ...
                foreach ($news_fetched as $row) {
                    ...
                    <div class="blog-one-item">
                        <div class="blog-one-photo">
                            <a href="<?php echo base_url(); ?>news/view/<?php echo $row->news_id; ?>"><img src="<?php echo base_url() . $path . $row->photo; ?>" alt="Blog Photo"></a>
                        </div>
