...
<?php if ($page_home['home_welcome_status'] == 'Show') : ?>
    <div class="about-area pt_10">

        <!-- <a href="https://itjen.kemkes.go.id/wbs/register" target="_blank" class="float">
            <img src="http://malangkab.jaylangkung.co.id/source/2/lapor.png">
        </a>
        <div class="label-container">
            <div class="label-text">WBS</div>
                        ...
                        <div class="video-section">
                            <div class="download-video">
                                <div style="position:relative;height:0;padding-bottom:56.21%">
                                    <iframe src="<?php echo $page_home['home_welcome_video']; ?>" style="position:absolute;width:100%;height:100%;left:0" width="480" height="360" allowfullscreen></iframe>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="video-box bg-area">
                            <div class="modal fade in" id="myModalvid" role="dialog">
...
<?php if ($page_home['home_service_status'] == 'Show') : ?>
    <div class="services-area pt_30 pb_30">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="headline">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="services-item effect-item">
                            <a href="<?php echo base_url(); ?>service/view/<?php echo $row['id']; ?>" class="image-effect">
                                <div class="services-photo" style="background-image: url(<?php echo base_url(); ?>rahasia/assets/upload/poli/<?php echo $row['photo']; ?>)"></div>
                            </a>
...
<?php if ($page_home['home_team_status'] == 'Show') : ?>
    <div class="team-area pt_20 pb_20">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="headline">
                        ...
                        <?php
                            ...
                            <div class="blog-item effect-item">
                                <a href="<?php echo base_url(); ?>news/view/<?php echo $news['news_id']; ?>" class="image-effect">
                                    <div class="blog-image" style="background-image: url(<?php echo base_url() . $path . $news['photo']; ?>)"></div>
                                </a>
                                <div class="blog-text">
