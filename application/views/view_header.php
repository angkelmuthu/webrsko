...
<head>
    ...
    if ($class_name == 'sejarah') {
        echo '<meta name="description" content="' . $page_sejarah['md_sejarah'] . '">';
        echo '<meta name="keywords" content="' . $page_sejarah['mk_sejarah'] . '">';
        echo '<title>' . $page_sejarah['mt_sejarah'] . '</title>';
    }
    if ($class_name == 'loker') {
        echo '<meta name="description" content="' . $page_sejarah['md_sejarah'] . '">';
        echo '<meta name="keywords" content="' . $page_sejarah['mk_sejarah'] . '">';
    ...
    if ($class_name == 'search') {
        echo '<meta name="description" content="search">';
        echo '<meta name="keywords" content="search">';
                ...
                <div class="col-lg-9 col-12 main-menu">
                    <div class="main-menu-item">
                        <ul class="nav-menu">
                            ...
                            <li class="menu-item-has-children"><a href="#">Layanan Kami</a>
                                <ul>
                                    <li><a href="<?php echo base_url(); ?>jadwal">Jadwal Dokter</a></li>
                                    ...
                                    <li><a href="https://reservasi.rsko-jakarta.com" target="_blank">PENDAFTARAN ONLINE</a></li>
                                    <li><a href="https://sididik.rsko-jakarta.com" target="_blank">PENDAFTARAN PESERTA DIDIK</a></li>
                                </ul>
                            </li>
