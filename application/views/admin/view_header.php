	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="<?php echo base_url(); ?>admin/dashboard" class="logo">
				<span class="logo-lg">Admin | RSKO</span>
			</a>
    		...
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
					...
					<li class="treeview <?php if( ($class_name == 'language') ) {echo 'active';} ?>">
			          <a href="<?php echo base_url(); ?>admin/feature">
			            <i class="fa fa-language"></i> <span>Shortcut Menu</span>
			          </a>
			        </li>
			        <li class="treeview <?php if( ($class_name == 'language') ) {echo 'active';} ?>">
			        ...
			        <li class="treeview <?php if( ($class_name == 'team_member') ) {echo 'active';} ?>">
			          <a href="<?php echo base_url(); ?>admin/team_member">
			            <i class="fa fa-users"></i> <span>Profil Direksi</span>
			          </a>
			        </li>
			        ...
			        <li class="treeview <?php if( ($class_name == 'category') || ($class_name == 'news') || ($class_name == 'comment') ) {echo 'active';} ?>">
						...
						<ul class="treeview-menu">
							<li><a href="<?php echo base_url(); ?>admin/service"><i class="fa fa-circle-o"></i> Poliklinik</a></li>
							<li><a href="<?php echo base_url(); ?>admin/testimonial"><i class="fa fa-circle-o"></i> Pelayanan Lain</a></li>
						</ul>
					</li>		        
			        ...
			        <li class="treeview <?php if( ($class_name == 'category') || ($class_name == 'news') || ($class_name == 'comment') ) {echo 'active';} ?>">
						...
						<ul class="treeview-menu">
							...
							<li><a href="<?php echo base_url(); ?>admin/news"><i class="fa fa-circle-o"></i> Artikel</a></li>
							<li><a href="<?php echo base_url(); ?>admin/comment"><i class="fa fa-circle-o"></i> Comment</a></li>
						</ul>
					</li>
                    <li class="treeview <?php if( ($class_name == 'laporan') ) {echo 'active';} ?>">
			          <a href="<?php echo base_url(); ?>admin/laporans">
			            <i class="fa fa-users"></i> <span>Laporan</span>
			          </a>
			        </li>
			   ...
			   <!--     <li class="treeview <?php if( ($class_name == 'portfolio')||($class_name == 'portfolio_category') ) {echo 'active';} ?>">-->
						...
						<!--	<li><a href="<?php echo base_url(); ?>admin/portfolio_category"><i class="fa fa-circle-o"></i> Portfolio Category</a></li>-->
							<li><a href="<?php echo base_url(); ?>admin/portfolio"><i class="fa fa-circle-o"></i> File</a></li>
					<!--	</ul>-->
					<!--</li>-->
