        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_17" data-toggle="tab">Sejarah</a></li>
                        <li><a href="#tab_2" data-toggle="tab">Visi Misi</a></li>
                        <li><a href="#tab_14" data-toggle="tab">Profil Direksi</a></li>
                        <li><a href="#tab_4" data-toggle="tab">Layanan Unggulan</a></li>
                        ...
                        <li><a href="#tab_18" data-toggle="tab">Loker</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab_17">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Sejarah Heading </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="sejarah_heading" class="form-control" value="<?php echo $page_sejarah['sejarah_heading']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Sejarah Content </label>
                                    <div class="col-sm-9">
                                        <textarea name="sejarah_content" class="form-control" cols="30" rows="10" id="editor2"><?php echo $page_sejarah['sejarah_content']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Meta Title </label>
                                    <div class="col-sm-9">
                                        <input type="text" name="mt_sejarah" class="form-control" value="<?php echo $page_sejarah['mt_sejarah']; ?>">
                                    </div>
                                </div>      
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Meta Keyword </label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="mk_sejarah" style="height:60px;"><?php echo $page_sejarah['mk_sejarah']; ?></textarea>
                                    </div>
                                </div>  
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Meta Description </label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="md_sejarah" style="height:60px;"><?php echo $page_sejarah['md_sejarah']; ?></textarea>
                                    </div>
                                </div>  
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_sejarah">Update</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
                        <div class="tab-pane" id="tab_18">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Loker Heading </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="sejarah_heading" class="form-control" value="<?php echo $page_loker['sejarah_heading']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Loker Content </label>
                                    <div class="col-sm-9">
                                        <textarea name="sejarah_content" class="form-control" cols="30" rows="10" id="editor3"><?php echo $page_loker['sejarah_content']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Meta Title </label>
                                    <div class="col-sm-9">
                                        <input type="text" name="mt_sejarah" class="form-control" value="<?php echo $page_loker['mt_sejarah']; ?>">
                                    </div>
                                </div>      
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Meta Keyword </label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="mk_sejarah" style="height:60px;"><?php echo $page_loker['mk_sejarah']; ?></textarea>
                                    </div>
                                </div>  
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Meta Description </label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="md_sejarah" style="height:60px;"><?php echo $page_loker['md_sejarah']; ?></textarea>
                                    </div>
                                </div>  
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-6">
                                        <button type="submit" class="btn btn-success pull-left" name="form_loker">Update</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>                        
