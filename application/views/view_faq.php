                        ...
                        foreach ($faqs as $row) {
                            ...
                            <div class="faq-item card">
                                <div class="faq-header" id="heading<?php echo $i; ?>">
                                    <button class="faq-button <?php if($i!=1) {echo 'collapsed';} ?>" data-toggle="collapse" data-target="#collapse<?php echo $i; ?>" aria-expanded="true" aria-controls="collapse<?php echo $i; ?>"><i class="fa fa-caret-right"></i><?php echo $row['name']; ?></button>
                                </div>
