...
<div class="row">
    <div class="col-xl-12">
	    ...
	    <tr><td>Short Content</td><td><?php echo $short_content; ?></td></tr>
	    <tr><td>Content</td><td><?php echo $content; ?></td></tr>
	    <tr><td>Client Name</td><td><?php echo $client_name; ?></td></tr>
	    <tr><td>Client Company</td><td><?php echo $client_company; ?></td></tr>
	    ...
	    <tr><td>Client Comment</td><td><?php echo $client_comment; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('tbl_portfolio') ?>" class="btn btn-primary waves-effect waves-themed">Kembali</a></td></tr>
	</table>
</div>
</div>
