                    ...
                    <div class="panel-content">
                        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <table class='table table-striped'>
                                ...
                                <tr>
                                    <td width='200'>Judul <?php echo form_error('name') ?></td>
                                    <td><input type="text" class="form-control" name="name" id="name" placeholder="Name" value="<?php echo $name; ?>" /></td>
                                </tr>
                                <!-- <tr>
                                    <td width='200'>Designation <?php echo form_error('designation') ?></td>
                                ...
                                <tr>
                                    <td width='200'>Content <?php echo form_error('comment') ?></td>
                                    <td> <textarea class="form-control" non_pks="3" name="comment" class="js-summernote" id="summernote"><?php echo $comment; ?></textarea></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="hidden" name="id" value="<?php echo $id; ?>" />
                                        ...
                                        <a href="<?php echo site_url('tbl_testimonial') ?>" class="btn btn-info waves-effect waves-themed"><i class="fal fa-sign-out"></i> Kembali</a></td>
                                </tr>
                            </table>
                        </form>
                    </div>
