        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#dt-basic-example").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "tbl_slider/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id",
                            "orderable": false
                        },{"data": "photo"},{"data": "heading"},{"data": "content"},{"data": "button1_text"},{"data": "button1_url"},{"data": "button2_text"},{"data": "button2_url"},{"data": "position"},
                        {
                            "data" : "action",
                            "orderable": false,
